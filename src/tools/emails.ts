...
export function registerEmailsTools(server: McpServer, nuntly: Nuntly): void {
  ...
  server.registerTool(
    'send-bulk-emails',
    {
      ...
      inputSchema: {
        fallback: z.object({ from: z.string().optional(), to: z.union([z.string(), z.array(z.string())]).optional(), cc: z.union([z.string(), z.array(z.string())]).optional(), bcc: z.union([z.string(), z.array(z.string())]).optional(), replyTo: z.union([z.string(), z.array(z.string())]).optional(), subject: z.string().optional(), text: z.string().optional(), html: z.string().optional(), headers: z.record(z.string(), z.unknown()).optional(), tags: z.array(z.object({ name: z.string().describe("The name of the tag"), value: z.string().describe("The tag to add to the email") })).optional(), variables: z.record(z.string(), z.unknown()).optional(), scheduledAt: z.string().optional() }).describe("Used as a fallback field email value if no value is present in emails").optional(),
        emails: z.array(z.object({ from: z.string().optional(), to: z.union([z.string(), z.array(z.string())]).optional(), cc: z.union([z.string(), z.array(z.string())]).optional(), bcc: z.union([z.string(), z.array(z.string())]).optional(), replyTo: z.union([z.string(), z.array(z.string())]).optional(), subject: z.string().optional(), text: z.string().optional(), html: z.string().optional(), headers: z.record(z.string(), z.unknown()).optional(), tags: z.array(z.object({ name: z.string().describe("The name of the tag"), value: z.string().describe("The tag to add to the email") })).optional(), variables: z.record(z.string(), z.unknown()).optional(), scheduledAt: z.string().optional() })).describe("The bulk emails to send"),
      },
      outputSchema: {
