...
export function registerEmailsTools(server: McpServer, nuntly: Nuntly): void {
  ...
  server.tool(
    ...
    tags: z.array(z.record(z.string(), z.unknown())).describe("The tags to add to the email").optional(),
    attachments: z.array(z.record(z.string(), z.unknown())).describe("The attachements to add to the email").optional(),
